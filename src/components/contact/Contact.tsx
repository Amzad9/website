        ...
        <div className="container mx-auto px-6 text-start">
          <div className="relative">
            <h1 className="text-7xl flex item-center text-white relative z-10 font-semibold mb-12 font-poppins">
              Let’s <span className="text-primary italic font-inter mx-3">Build</span>{" "}
              Together! <button className="ms-5 bg-transparant border-2 text-white hover:border-green-600 text-black font-semibold w-12 h-12 flex justify-center items-center rounded-full">
            <PlusCircle />
          </button>
            </h1>
