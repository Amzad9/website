      ...
      <div className="relative">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="relative w-24 h-24">
            {/* Vertical line */}
            <motion.div
              className="absolute left-1/2 -translate-x-1/2 w-2 h-full bg-gradient-to-b from-primary to-blue-500 rounded-full"
              animate={{
                scaleY: [1, 0.3, 1],
                opacity: [0.5, 1, 0.5],
              }}
            ...
            {/* Horizontal line */}
            <motion.div
              className="absolute top-1/2 -translate-y-1/2 w-full h-2 bg-gradient-to-r from-primary to-blue-500 rounded-full"
              animate={{
                scaleX: [1, 0.3, 1],
                opacity: [0.5, 1, 0.5],
              }}
