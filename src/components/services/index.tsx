...
export default function Services() {
  ...
  const services = [
    {
      ...
      description: "Custom websites that drive engagement, conversions, and brand recognition across all devices.",
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M21 15L21 5C21 3.89543 20.1046 3 19 3L5 3C3.89543 3 3 3.89543 3 5L3 15C3 16.1046 3.89543 17 5 17L19 17C20.1046 17 21 16.1046 21 15Z" stroke="url(#webGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M9 21H15" stroke="url(#webGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M7.5 7L11.5 11L7.5 15" stroke="url(#webGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
      features: ["Responsive design", "SEO optimization", "Performance tuning", "Custom CMS"],
    ...
    },
    {
      ...
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="5" y="2" width="14" height="20" rx="3" stroke="url(#mobileGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M12 18H12.01" stroke="url(#mobileGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M9 22H15" stroke="url(#mobileGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M10 5.5C10 5.22386 10.2239 5 10.5 5H13.5C13.7761 5 14 5.22386 14 5.5C14 5.77614 13.7761 6 13.5 6H10.5C10.2239 6 10 5.77614 10 5.5Z" fill="url(#mobileGradient)"/>
        </svg>
      ),
      features: ["iOS & Android apps", "Cross-platform solutions", "App store optimization", "Ongoing support"],
    ...
    },
    {
      ...
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M6 3H3V6" stroke="url(#designGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M21 3H18V6" stroke="url(#designGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M18 21H21V18" stroke="url(#designGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M6 21H3V18" stroke="url(#designGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <circle cx="12" cy="12" r="4" stroke="url(#designGradient)" strokeWidth="2"/>
          <path d="M12 12L15.5 8.5" stroke="url(#designGradient)" strokeWidth="2" strokeLinecap="round"/>
        </svg>
      ),
    ...
    },
    {
      ...
      description: "Strategic marketing solutions that increase visibility, drive traffic, and boost conversions.",
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
          ...
          <path d="M16 8.00001L18 10M18 10L20 12M18 10L16 12M18 10L20 8.00001" stroke="url(#marketingGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M4 21.4V5.6C4 5.26863 4.26863 5 4.6 5H19.4C19.7314 5 20 5.26863 20 5.6V8" stroke="url(#marketingGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M4 10H8.5" stroke="url(#marketingGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M4 14H12" stroke="url(#marketingGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M14 21V15.5" stroke="url(#marketingGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M10 21V17.5" stroke="url(#marketingGradient)" strokeWidth="2" strokeLinecap="round"/>
          <path d="M6 21V19.5" stroke="url(#marketingGradient)" strokeWidth="2" strokeLinecap="round"/>
        </svg>
      ),
  ...
  return (
    <main id="service" className="flex flex-col min-h-screen relative bg-[#050505]">
      <Head>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="p-6 flex justify-between items-start relative z-10">
                  <div>
                    <div className={`inline-flex mb-4 bg-gradient-to-r ${service.color} bg-clip-text relative`}>
                      <h3 className="text-2xl md:text-3xl font-bold text-transparent tracking-tight">
                        {service.title}
                      </h3>
                      <div className={`absolute -bottom-2 left-0 h-[2px] w-0 bg-gradient-to-r ${service.color} group-hover:w-full transition-all duration-500 ease-out`}></div>
                    </div>
                  ...
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center border border-white/10 bg-black/30 group-hover:border-white/20 transition-all duration-300`}>
                    {service.icon}
                  </div>
                </div>
                ...
                <div className="px-6 py-4 flex-grow">
                  <div className="grid grid-cols-1 gap-3">
                    {service.features.map((feature, index) => (
                      <div key={index} className="flex items-center gap-3 group-hover:translate-x-1 transition-transform duration-500 ease-out" style={{ transitionDelay: `${index * 50}ms` }}>
                        <div className={`h-px w-5 bg-gradient-to-r ${service.color} opacity-70 group-hover:w-8 transition-all duration-300`}></div>
                ...
                <div className="absolute bottom-4 right-4">
                  <div className={`opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-xs text-white/40 flex items-center gap-1`}>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="mb-12">
                ...
                <p className="text-gray-300 text-lg max-w-2xl mx-auto mt-8 relative font-light">
                  Schedule a consultation with our experts and discover how our digital solutions can help you achieve your business goals.
                </p>
              </div>
