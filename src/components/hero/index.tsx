    ...
    <section id="home" className="relative min-h-screen overflow-hidden pt-24 pb-5 bg-[#000000]">
      ...
      <div className="container mx-auto px-4 min-h-screen flex items-center justify-center relative z-20">
        <div className="max-w-4xl mx-auto text-center relative z-30">
          ...
          <p className={`text-lg md:text-xl text-white/80 mb-10 leading-relaxed max-w-xl mx-auto ${styles["animate-fade-in"]} ${styles["delay-2"]}`}>
            Supercharge your online presence with our lightning-fast, high-performance web solutions.
          </p>

          <div className={`flex flex-col sm:flex-row items-center justify-center gap-4 ${styles["animate-fade-in"]} ${styles["delay-3"]}`}>
            <a href="#contact" className="group relative px-8 py-2 rounded-full bg-gradient-to-r from-[#DAA520] to-[#1E6FD9] transition-all duration-300">
            ...
            <Link href="/showcase" className="group px-8 py-2 rounded-full border border-[#DAA520]/20 hover:bg-[#DAA520]/5 transition-colors duration-300">
              <div className="flex items-center justify-center gap-2">
