      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/10 to-blue-500/10 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
              <div className="relative p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-sm border border-primary/20">Innovation</span>
                  <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-sm border border-primary/20">Growth</span>
                  <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-sm border border-primary/20">Excellence</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative group"
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/10 to-primary/10 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
              <div className="relative p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-sm border border-blue-500/20">Leadership</span>
                  <span className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-sm border border-blue-500/20">Innovation</span>
                  <span className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-sm border border-blue-500/20">Connection</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            {[
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-tr from-primary/5 to-blue-500/5 rounded-xl blur-lg group-hover:blur-xl transition-all duration-300"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/10 to-blue-500/10 rounded-3xl blur-2xl group-hover:blur-3xl transition-all duration-500"></div>
              
              {/* Main testimonial card */}
              <div className="relative p-8 md:p-12 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm">
                {/* Quote Icon */}
                <div className="absolute -top-6 left-8 p-4 rounded-full bg-gradient-to-tr from-primary/20 to-blue-500/20 border border-primary/20 shadow-lg shadow-primary/10">
                ...
                <div className="flex items-center gap-6">
                  <div className="relative">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-primary/20 to-blue-500/20 border border-primary/20 flex items-center justify-center shadow-lg shadow-primary/10">
                      <span className="text-2xl font-semibold text-primary">
                        S
                      </span>
                    </div>
                    <div className="absolute -bottom-1 -right-1 p-2 rounded-full bg-primary/10 border border-primary/20">
          ...
          >
            <button className="group relative px-8 py-3 rounded-full bg-gradient-to-r from-primary to-blue-500 transition-all duration-300">
              <div className="flex items-center justify-center gap-2">
                <span className="text-white font-medium">Start Your Success Story</span>
                <svg className="w-4 h-4 transform group-hover:translate-x-1 transition-transform duration-300 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
