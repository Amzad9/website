...
function index() {
  return (
    <div className="min-h-screen bg-black text-white p-8 mt-20">
      ...
      <p className="text-lg mb-4">Effective Date:</p>
      ...
      <h3 className="text-2xl font-bold mb-2">Non-Personal Information</h3>
      <p className="text-lg mb-4">We use non-personal information to:</p>
      <ul className="list-disc list-inside text-lg mb-4">
      ...
      <ul className="list-disc list-inside text-lg mb-4">
        <li>
          Secure Socket Layer (SSL) technology to encrypt data transmissions
        </li>
        <li>Regular security audits and vulnerability assessments</li>
        <li>Access controls and restricted access to sensitive information</li>
        <li>
          Physical and electronic security measures to protect against
          unauthorized access
        </li>
      </ul>
      ...
      <p className="text-lg mb-4">Weblibron</p>
      <p className="text-lg mb-4">+91 8178614811</p>
      <p className="text-lg mb-4">info@weblibron.com</p>
      <p className="text-lg mb-4">
