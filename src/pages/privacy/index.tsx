      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <section aria-labelledby="information-collection" className="mb-12">
            <h2 id="information-collection" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">1. Information Collection</h2>
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Non-Personal Information</h3>
            <p className="text-base mb-4 text-gray-200">
          ...
          <section aria-labelledby="information-usage" className="mb-12">
            <h2 id="information-usage" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">2. Use of Information</h2>
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Personal Information</h3>
            <p className="text-base mb-4 text-gray-200">
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Non-Personal Information</h3>
            <p className="text-base mb-4 text-gray-200">We use non-personal information to:</p>
            <ul className="list-disc list-inside text-base space-y-3 mb-8 text-gray-200" role="list">
          ...
          <section aria-labelledby="information-protection" className="mb-12">
            <h2 id="information-protection" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">3. Information Protection</h2>
            <p className="text-base mb-4 text-gray-200">
          ...
          <section aria-labelledby="information-sharing" className="mb-12">
            <h2 id="information-sharing" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">4. Information Sharing</h2>
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Third-Party Service Providers</h3>
            <p className="text-base mb-4 text-gray-200">
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Legal Requirements</h3>
            <p className="text-base mb-8 text-gray-200">
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Business Transfers</h3>
            <p className="text-base mb-8 text-gray-200">
          ...
          <section aria-labelledby="cookies-tracking" className="mb-12">
            <h2 id="cookies-tracking" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">5. Cookies and Tracking Technologies</h2>
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Cookies</h3>
            <p className="text-base mb-8 text-gray-200">
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Tracking Technologies</h3>
            <p className="text-base mb-4 text-gray-200">
          ...
          <section aria-labelledby="third-party-links" className="mb-12">
            <h2 id="third-party-links" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">6. Links to Third-Party Sites</h2>
          ...
          <section aria-labelledby="user-rights" className="mb-12">
            <h2 id="user-rights" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">8. Your Rights and Choices</h2>
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Access and Correction</h3>
            <p className="text-base mb-8 text-gray-200">
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Opt-Out</h3>
            <p className="text-base mb-8 text-gray-200">
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-100">Deletion</h3>
            <p className="text-base mb-8 text-gray-200">
          ...
          <section aria-labelledby="policy-updates" className="mb-12">
            <h2 id="policy-updates" className="text-xl md:text-2xl font-bold mb-4 text-white border-b border-gray-700 pb-2">9. Policy Updates</h2>
            <p className="text-base text-gray-200">
